        ...
        <div class="row">
            ...
            <div class="col-10 main">
                <div class="main">
                    ...
                    <div v-if="book.MaSach" class="mt-4">
                        <p>
                            Mã sách: <b>{{ book.MaSach }}</b>
                        </p>
                    </div>
                    <div v-if="book.TenSach">
                        <p>
                            Tên sách: <b>{{ book.TenSach }}</b>
                        </p>
                    </div>
                    <div v-if="book.TacGia">
                        <p>
                    ...
                    <div v-if="book.SoQuyen">
                        <p>
                            Số lượng: <b>{{ book.SoQuyen }}</b>
                        </p>
                    </div>
                    <div v-if="book.MaNXB">
                        <p>
                            Mã nhà xuất bản: <b>{{ book.MaNXB }}</b>
                        </p>
                    </div>
                    <div v-else>
                        <p>Mã nhà xuất bản: <b>Cộng đồng</b></p>
                    </div>
                    <div v-if="book.NamXuatBan">
                        <p>
                            Năm xuất bản: <b>{{ book.NamXuatBan }}</b>
                        </p>
                    </div>
                    <div v-if="book.MoTa" class="mb-2">
                        <p class="mb-2">Mô tả sách:</p>
                        <div v-html="book.MoTa"></div>
                    </div>
