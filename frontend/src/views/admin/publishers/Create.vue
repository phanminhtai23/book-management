    ...
    methods: {
        validate() {
            ...
            if (!this.publisher.MaNXB) {
                this.errors.MaNXB = "Publisher Id is required";
                isValid = false;
                return;
            }
            if (!this.publisher.HoTen) {
        ...
        onCancel() {
            ...
            this.publisher.HoTen = "";
            this.publisher.DiaChi = "";
        },
