        ...
        <div class="row">
            ...
            <div class="col-10 main">
                <div class="main">
                    ...
                    <div v-if="account.MSNV">
                        <p>
                            Mã nhân viên: <b>{{ account.MSNV }}</b>
                        </p>
                    </div>
                    <div v-if="account.HoTenNV">
                        <p>
                            Họ và tên: <b>{{ account.HoTenNV }}</b>
                        </p>
                    </div>
                    <div v-if="account.ChucVu">
                        <p>
                            Chức vụ: <b>{{ account.ChucVu }}</b>
                        </p>
                    </div>
                    <div v-if="account.DiaChi">
                        <p>
                            Địa chỉ: <b>{{ account.DiaChi }}</b>
                        </p>
                    </div>
                    <div v-if="account.SoDienThoai">
                        <p>
                            Số điện thoại: <b>{{ account.SoDienThoai }}</b>
                        </p>
                    </div>
                    <div v-if="account.status">
                        ...
                        <span v-else class="badge badge-danger"
                            >Trạng thái: Dừng hoạt động</span
                        >
                    </div>
                    <div class="mt-4">
                        <router-link
