        ...
        <div class="row">
            ...
            <div class="col-10 main">
                <div class="main">
                    ...
                    <div v-if="user.MaDocGia" class="mt-4">
                        <p>
                            Mã người dùng: <b>{{ user.MaDocGia }}</b>
                        </p>
                    </div>
                    <div v-if="user.HoTen">
                        <p>
                            Tên người dùng: <b>{{ user.HoTen }}</b>
                        </p>
                    </div>
                    <div v-if="user.DienThoai">
                        <p>
                            Số điện thoại: <b>{{ user.DienThoai }}</b>
                        </p>
                    </div>
                    <div v-if="user.DiaChi">
                        <p>
                    ...
                    <div v-if="user.Phai">
                        <p>
                            Giới tính: <b>{{ user.Phai }}</b>
                        </p>
                    </div>
                    <div v-else>
                        <p>Giới tính: <b>Không cung cấp</b></p>
                    </div>
                    <div v-if="user.NgaySinh">
                        <p>
                            Năm sinh: <b>{{ user.NgaySinh }}</b>
                        </p>
                    </div>
